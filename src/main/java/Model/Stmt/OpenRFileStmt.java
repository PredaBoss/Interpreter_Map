...
public class OpenRFileStmt implements IStmt{
    ...
    @Override
    public PrgState execute(PrgState state) throws ExpException, StmtException, FileNotFoundException {
        ...
        if(fileTable.isDefined(stringValue))
            throw new ExpException("This filename already exists");

        BufferedReader reader = new BufferedReader(new FileReader(((StringValue)symTable.lookup(stringValue.getVal())).getVal()));
